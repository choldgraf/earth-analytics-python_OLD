...
title: "Intro to Python & Time series data"
...
data in `Python` and `Jupyter Notebooks`. We will also learn how to work with data collected
...
|  time | topic   | speaker   |
|---|---|---|---|---|
| 3:00 pm  | Get to know Python & Jupyter notebooks  / questions  | Leah  |
| 3:20 - 4:00  | Python coding session - Intro to Scientific programming with Python   | Leah  |
| 4:15 - 5:50  | Python coding session continued  | Leah  |


## <i class="fa fa-pencil"></i> Homework Week 2

### 1. Install a New R Package & Download data
**Important:** This week we will use the following python libraries:


 If you need a reminder about how to install packages in Python,

...
# sjer_plot_locations = gpd.read_file(op.join(path_data, 'california', 'SJER', 'vector_data', 'SJER_plot_centroids.shp'))

test = gpd.read_file(filename="data/week5/california/SJER/vector_data/SJER_plot_centroids.shp")
```
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x119beb160>
